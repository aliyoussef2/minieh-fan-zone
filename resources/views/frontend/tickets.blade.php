...
.page-header { padding: 140px 60px 40px; text-align: center; position:relative; overflow:hidden; }
...
.zone { border-radius:8px; padding:6px; display:flex; flex-direction:column; gap:3px; flex:1; transition: border-color 0.3s, box-shadow 0.3s; }
.zone:hover { box-shadow: 0 0 20px rgba(255,215,0,0.1); }
...
.cu:hover,.cu.sel { transform:rotate(90deg) scale(1.12); z-index:10; filter:brightness(1.3); }
...
.sel-card { background:rgba(255,255,255,0.03); backdrop-filter:blur(20px); border:1px solid rgba(255,215,0,0.2); border-radius:12px; padding:14px; box-shadow:0 0 25px rgba(255,215,0,0.08); }
.sel-title { font-size:8px; color:rgba(255,255,255,0.4); letter-spacing:2px; margin-bottom:4px; }
.sel-count { font-family:'Bebas Neue',cursive; font-size:32px; color:#FFD700; line-height:1; text-shadow:0 0 25px rgba(255,215,0,0.4); }
...
.book-btn { width:100%; padding:12px; background:#FFD700; color:#0B1220; border:none; border-radius:9px; font-family:'Bebas Neue',cursive; font-size:1rem; letter-spacing:.15em; cursor:pointer; transition:all .2s cubic-bezier(0.16,1,0.3,1); box-shadow:0 0 25px rgba(255,215,0,0.3); }
.book-btn:hover { box-shadow:0 0 40px rgba(255,215,0,0.55); transform:translateY(-1px); }
.book-btn:disabled { opacity:.3; cursor:not-allowed; box-shadow:none; transform:none; }
.clear-btn { width:100%; padding:7px; background:transparent; border:1px solid rgba(255,255,255,0.1); border-radius:7px; font-size:10px; color:rgba(255,255,255,0.4); cursor:pointer; font-family:'Instrument Sans',sans-serif; transition: border-color 0.2s, color 0.2s; }
.clear-btn:hover { border-color:rgba(255,215,0,0.4); color:#FFD700; }
.leg { padding:8px; background:rgba(255,255,255,0.03); backdrop-filter:blur(20px); border:1px solid rgba(255,215,0,0.1); border-radius:8px; display:flex; flex-direction:column; gap:4px; }
